        ...
        child: Column(
          ...
          //  Tile for predictions
            ...
            itemBuilder: (context, index){
              return PredictionTile(predictions: placePredictionList[index],);
            },
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 8.0,),
                      Text(predictions.main_text, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16.0),),
                      SizedBox(height: 2.0,),
                      Text(predictions.secondary_text, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12.0, color: Colors.grey),),
                    ],
                  ),
                )
              ],
